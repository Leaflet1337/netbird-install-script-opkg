...
Используемая по умолчанию сеть Netbird - 100.64.0.0/10
   
<br>

Теперь нужно установить репозиторий системы пакетов [Entware]([https://forum.keenetic.net/topic/4299-entware/](https://support.netcraze.ru/ultra/nc-1812/ru/18482-installing-opkg-entware-in-the-router-s-internal-memory.html)).
...
Авторизвавшись в cli Entware установить пакет curl 
```
opkg install curl
```

Далее запустите процесс установки и автоматической настройки  следующей командой в терминале вашего устройства:
